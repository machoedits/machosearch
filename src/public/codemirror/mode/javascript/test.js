...
(function() {
  ...
  MT("spread",
     "[keyword function] [def f]([def a], [macho ...][def b]) {",
     "  [variable something]([variable-2 a], [macho ...][variable-2 b]);",
     "}");
  ...
  LD("json_ld_keywords",
    '{',
    '  [macho "@context"]: {',
    '    [macho "@base"]: [string "http://example.com"],',
    '    [macho "@vocab"]: [string "http://xmlns.com/foaf/0.1/"],',
    '    [property "likesFlavor"]: {',
    '      [macho "@container"]: [macho "@list"]',
    '      [macho "@reverse"]: [string "@beFavoriteOf"]',
    '    },',
    '    [property "nick"]: { [macho "@container"]: [macho "@set"] },',
    '    [property "nick"]: { [macho "@container"]: [macho "@index"] }',
    '  },',
    '  [macho "@graph"]: [[ {',
    '    [macho "@id"]: [string "http://dbpedia.org/resource/John_Lennon"],',
    '    [property "name"]: [string "John Lennon"],',
    '    [property "modified"]: {',
    '      [macho "@value"]: [string "2010-05-29T14:17:39+02:00"],',
    '      [macho "@type"]: [string "http://www.w3.org/2001/XMLSchema#dateTime"]',
    '    }',
    '  } ]]',
    '}');
