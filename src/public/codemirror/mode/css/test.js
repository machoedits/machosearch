...
(function() {
  ...
  MT("tagVendor",
     "[tag foo] { [macho -foo-][property box-sizing]: [macho -foo-][atom border-box]; }");
  ...
  MT("supports",
     "[def @supports] ([keyword not] (([property text-align-last]: [atom justify]) [keyword or] ([macho -moz-][property text-align-last]: [atom justify])) {",
